...
KOMODO_DB_PASSWORD=op://Secrets/Komodo/Core/mongo_pass

## Configure a secure passkey to authenticate between Core / Periphery.
KOMODO_PASSKEY=op://Secrets/Komodo/Core/passkey
...
KOMODO_WEBHOOK_SECRET=op://Secrets/Komodo/Core/webhook_secret
## Used to generate jwt. Alt: KOMODO_JWT_SECRET_FILE
KOMODO_JWT_SECRET=op://Secrets/Komodo/Core/jwt
...
PERIPHERY_ROOT_DIRECTORY=/home/cwel/.komodo
